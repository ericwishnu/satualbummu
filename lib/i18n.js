...
export const dict = {
  en: {
    ...
    btnClosed: 'Uploads closed',
    hintClosed: 'Uploads are closed — the gallery is now open.',
    errClosed: 'Uploads are closed — the gallery is now open.',
    ghostAria: 'Choose from gallery',
    hint: 'Take Photo opens the camera · use the icons for QR & gallery',
    ...
    qrAria: 'Show QR code to invite friends',
    inviteTitle: 'Invite guests to your event.',
    inviteSub: 'See the world through their eyes. Invite your guests to make this event unforgettable.',
  ...
  id: {
    ...
    btnClosed: 'Unggahan ditutup',
    hintClosed: 'Unggahan sudah ditutup — galeri sudah dibuka.',
    errClosed: 'Unggahan sudah ditutup — galeri sudah dibuka.',
    ghostAria: 'Pilih dari galeri',
    hint: 'Ambil Foto membuka kamera · ikon untuk QR & galeri',
    ...
    qrAria: 'Tampilkan kode QR untuk mengundang teman',
    inviteTitle: 'Undang tamu ke acaramu.',
    inviteSub: 'Lihat dunia dari sudut pandang mereka. Undang tamumu untuk membuat acara ini tak terlupakan.',
